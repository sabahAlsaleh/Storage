...
namespace Storage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult ProductInventory()
        {
            ...
            // Mappa till ViewModel och beräkna InventoryValue
            var productViewModels = products.Select(p => new ProductViewModel
            {
                Name = p.Name,
                Price = p.Price,
                Count = p.Count,
                InventoryValue = p.Price * p.Count // Beräkna totala värdet
            }).ToList();
        ...
        {
            // Filtrera produkterna baserat på kategori
            ...
            return View("ProductInventory", filteredProducts);
        }
